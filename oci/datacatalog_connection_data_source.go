...
func init() {
	RegisterDatasource("oci_datacatalog_connection", DatacatalogConnectionDataSource())
}
...
func DatacatalogConnectionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatacatalogConnectionResource(), fieldMap, readSingularDatacatalogConnection)
}
