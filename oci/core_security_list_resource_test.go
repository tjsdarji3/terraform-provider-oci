...
func (s *ResourceCoreSecurityListTestSuite) BuildTestsForFullConfig(resourceName, prefix string) []resource.TestCheckFunc {
	return []resource.TestCheckFunc{
		...
		CheckResourceSetContainsElementWithProperties(resourceName, prefix+"ingress_security_rules", map[string]string{
			"source":         "0.0.0.0/5",
			"icmp_options.#": "0",
			"tcp_options.#":  "0",
			"udp_options.#":  "0",
			...
			// Update to add ICMP options
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					CheckResourceSetContainsElementWithProperties(s.ResourceName, "egress_security_rules", map[string]string{
						...
						nil),
					CheckResourceSetContainsElementWithProperties(s.ResourceName, "ingress_security_rules", map[string]string{
						"icmp_options.#":      "1",
						"icmp_options.0.code": "4",
						"icmp_options.0.type": "3",
					},
