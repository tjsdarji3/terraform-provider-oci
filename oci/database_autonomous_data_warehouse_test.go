		...
		Steps: []resource.TestStep{
			...
			// verify datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "autonomous_data_warehouses.0.connection_strings.#", "1"),
					...
					resource.TestCheckResourceAttrSet(datasourceName, "autonomous_data_warehouses.0.db_version"),
					...
					resource.TestCheckResourceAttrSet(datasourceName, "autonomous_data_warehouses.0.time_created"),
				),
			},
...
func init() {
	...
	if !inSweeperExcludeList("DatabaseAutonomousDataWarehouse") {
