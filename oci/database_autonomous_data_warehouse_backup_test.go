		...
		Steps: []resource.TestStep{
			...
			// verify datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(datasourceName, "autonomous_data_warehouse_backups.0.time_ended"),
					resource.TestCheckResourceAttrSet(datasourceName, "autonomous_data_warehouse_backups.0.time_started"),
